...
int main(int argc, char **argv)
{
  ...
  ros::Publisher point_pub = nh.advertise<geometry_msgs::Point>("point2",2);
  ros::Publisher mtheta_p_pub = nh.advertise<geometry_msgs::Point>("theta_p2",2);
  ...
  while(ros::ok()){
    ...
    measure <<mocap_pitch , omega_p ,a_x_I,a_z_I ,-ukf_data.force.x,-ukf_data.force.z ;
